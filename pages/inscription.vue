    ...
    <div class="container mx-auto">
        <div class="max-w-md mx-auto my-10 bg-white p-5 rounded-md shadow-sm">
            <div class="text-center">
                <h1 class="my-3 text-3xl font-semibold text-gray-700 dark:text-gray-200">Suscribe</h1>
                <p class="text-gray-400 dark:text-gray-400">Fill up the form below to Suscribe.</p>
            </div>
            <div class="m-7">
                <form >
                    ...
                    <div class="mb-6">
                        <button @click.prevent="sendSub" class="w-full px-3 py-4 text-white bg-indigo-500 rounded-md focus:bg-indigo-600 focus:outline-none">Subscribe</button>
                    </div>
  ...
  methods: {
    sendSub: function() {
      ...
      console.log(this.firstName, this.lastName, this.passWord, this.email, this.age );
                    const url = "http://127.0.0.1:3030/api/v1/register"
               fetch(
                   url,
                   {
                       method: "POST",
